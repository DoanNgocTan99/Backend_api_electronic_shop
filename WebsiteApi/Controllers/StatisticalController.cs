...
namespace WebsiteApi.Controllers
{
    public class StatisticalController : BaseApiController
    {
        ...
        /// </summary>
        /// <returns></returns>
        [HttpPost("GetFileExcel")]
        public ActionResult<string> GetFileExcel([FromBody] DateExportExcel value)
        {
            try
            {
                DateTime fromDateOld = new DateTime();
                DateTime toDateOld = new DateTime();
                if(value.FromDate == fromDateOld && value.ToDate == toDateOld)
                {
                ...
                IEnumerable<LatestOrder> LatestOrders = _statisticalService.GetLatestOrdersByDate(value);
                IEnumerable<TopCustomerDto> TopCustomers = _statisticalService.GetTopCustomersByDate(value);
