...
CREATE TABLE [Product](
	...
	[Description] NVARCHAR(250) NOT NULL DEFAULT 'defaut',
	--- Thuong hieu
	[Brand] NVARCHAR(250) NULL DEFAULT 'defaut',
	--Chat lieu
...
CREATE TABLE [Image] (
	...
	[CreatedDate] DATETIME  DEFAULT CURRENT_TIMESTAMP,
	[Del] BIT NOT NULL DEFAULT 0,
	FOREIGN KEY ([Pro_Id_Img]) REFERENCES dbo.Product(Id),
	FOREIGN KEY ([Cate_Id_Img] ) REFERENCES dbo.Category(Id),
	FOREIGN KEY ([User_Id_Img]) REFERENCES dbo.[User](Id)
)
...
CREATE TABLE [Order](
	...
	FOREIGN KEY (User_Id_Order) REFERENCES dbo.[User](Id)
) 
